...
<body>
    ...
    <main>
        ...
        <label for="saque">Qual o valor que você deseja sacar?
        (R$) <sup>*</sup></label>


        <input type="number" name="saque" id="saque" step="5" min="5" required value="<?= $saque ?>">
        ...
        <?php
         if ($saque <= 0) {
                              $erro = "Digite um valor válido para saque (maior que zero).";} 
                else{
                        $resto = $saque;
                        //saque de 100
